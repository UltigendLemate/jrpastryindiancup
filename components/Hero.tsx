  ...
  return (
    <div className=' w-[100vw] md:w-[98.8vw] py-16 md:py-2 p-2 relative mt-28   bg-white min-h-[75vh] md:min-h-[90vh] text-primary mainbg grid  justify-center items-center font-pop'>
      ...
      <div className='z-20'>
        ...
        <h2 className='text-md p-2 text-center sm:text-2xl md:text-2xl mt-3 font-semibold text-white'>03-04 August 2025, Indian Expo Centre & Mart, Greater Noida, NCR, India</h2>
